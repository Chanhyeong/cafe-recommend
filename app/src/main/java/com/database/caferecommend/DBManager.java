...
public class DBManager extends SQLiteOpenHelper {
    private final String[][] cafeData = {
            {"할리스커피", "031-211-2884", "8", "경기", "경기 수원시 영통구 중부대로 258", "일반"},
            {"커피볶는수", "010-6460-0602", "9", "22", "경기", "경기 수원시 팔달구 우만동 62-1", "일반"},
            {"탐앤탐스", "031-241-2341", "10", "23", "경기", "경기도 수원시 영통구 원천동 18-1 아록빌딩 1층", "일반"},
            {"스타벅스", "031-215-4516", "10", "경기", "경기도 수원시 팔달구 우만동 58-32 오스타스토리빌딩 1층", "일반"},
            {"봄봄", "031-123-3214", "9", "22", "경기", "경기 수원시 팔달구 우만동 30-1", "일반"},
            {"커피만", "031-456-7890", "11", "경기", "경기 수원시 팔달구 우만동 36-6", "일반"},
            {"나인어클락", "031-123-2345", "12", "경기", "경기 수원시 팔달구 우만동 571-3 2층", "일반"},
            {"커피나무", "031-211-2342", "11", "경기", "경기도 수원시 팔달구 우만동 577-1", "일반"},
            {"스타벅스", "02-542-1268", "8", "서울", "서울특별시 강남구 신사동 580-2 관영빌딩 1층", "일반"},
            {"스타벅스", "033-231-5235", "8", "강원", "강원도 춘천시 효자동 632-3", "일반"},
            {"스타벅스", "032-789-1235", "8", "인천", "인천광역시 부평구 부평동 159-25", "일반"},
            {"탐앤탐스", "061-877-2310", "9", "전남", "전라남도 목포시 대안동 12-1", "일반"},
            {"할리스커피", "062-665-0938", "11", "광주", "광주광역시 동구 지산동 518-18", "일반"},
            {"카페베네", "064-555-0931", "7", "제주", "제주특별자치도 제주시 한림읍 협재리 2447-46", "일반"},
            {"카페베네", "055-674-2314", "7", "경남", "경상남도 사천시 벌리동 253-8", "일반"},
            {"카페베네", "063-443-7351", "7", "전북", "전라북도 군산시 중앙로2가 12-4", "일반"},
            {"엔젤리너스", "042-423-5246", "8", "대전", "전북도 군산시 수송로 213", "일반"},
            {"엔젤리너스", "041-342-4325", "9", "충남", "충청남도 아산시 배방읍 장재리 13-1", "일반"},
            {"이디야커피", "053-734-4415", "9", "대구", "대구광역시 중구 중앙대로 400-1", "일반"}
    };
