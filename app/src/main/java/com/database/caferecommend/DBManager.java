...
public class DBManager extends SQLiteOpenHelper {
    ...
    private final String[][] cafeData = {
            ...
            {"애견카페왈", "031-239-4856", "9", "24", "경기", "경기도 수원시 권선구 동수원로146번길 219", "애견"},
            {"언니네 애견카페", "031-215-7271", "9", "24", "경기", "경기도 수원시 영통구 동수원로 542-49", "애견"},
            {"딩고", "070-4242-5959", "9", "24", "경기", "경기도 수원시 영통구 태장로54번길 166 1층", "애견"},
            {"요기도기", "053-562-1230", "9", "24", "대구", "대구광역시 달서구 와룡로 169 대우월드마크웨스트앤드 상가 103-118호", "애견"},
    };
    ...
    private final String[][] brandData = {
            ...
            {"애견카페왈", "dogwal_icon"},{"언니네 애견카페", "uni_icon"},{"딩고","dingo_icon"},{"요기도기","yogi_icon"}
    ...
    private final String[][] menuData = {
            ...
            {"목욕", "15000", "애견카페왈", "dog_wash"},{"애견스낵", "10000", "애견카페왈", "dog_snack"},
            {"애견토이", "8000", "애견카페왈", "dog_toy"},{"애견유치원", "40000", "애견카페왈", "dog_kin"},
            {"목욕", "20000", "언니네 애견카페", "dog_wash"},{"애견스낵", "8000", "언니네 애견카페", "dog_snack"},
            {"애견토이", "6000", "언니네 애견카페", "dog_toy"},
            {"목욕", "15000", "딩고", "dog_wash"},{"애견스낵", "10000", "딩고", "dog_snack"},
            {"애견토이", "8000", "딩고", "dog_toy"},{"애견유치원", "40000", "딩고", "dog_kin"},
            {"목욕", "15000", "요기도기", "dog_wash"},{"애견스낵", "10000", "요기도기", "dog_snack"},
            {"애견토이", "8000", "요기도기", "dog_toy"},{"애견유치원", "40000", "요기도기", "dog_kin"}
    };
    ...
    private final String[][] pictureData = {
            ...
            {"tom_in", "3"}, {"tom_in", "12"},{"dog_wal_in","13"},{"uni_in","14"},{"dingo_in","15"},{"yogi_in","16"}
    };
    ...
    public String getByQuery(String select, String from, String where){
        ...
        else if(from.equalsIgnoreCase("review")) {
            while (cursor.moveToNext()) {
                // 파일전송 포맷 json
                str += "{"
                        + "'score':'"
        ...
        else if(from.equalsIgnoreCase("picture")) {
            while (cursor.moveToNext()) {
                // 파일전송 포맷 json
                str += "{"
                        + "'imageName':'"
